...
class PaginaVerEventoPorValidar extends StatefulWidget {
...
class _CarregandoPaginaState extends State<PaginaVerEventoPorValidar> {
  double? _latitude;
  double? _longitude;
  late int user_id;
  late String nomeCriador = '';
  late String caminhoFotoCriador = '';
  List<String> _imagensCaminhos = [];
  ...
  void initState() {
    ...
    _carregarImagensDoEvento();
  }

  void _carregarImagensDoEvento() async {
    _imagensCaminhos = await Funcoes_Eventos_Imagens()
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _imagensCaminhos.isNotEmpty
                            ? ImageGalleryLayout2(
                                nome: widget.titulo,
                                imagePaths:
                                    _imagensCaminhos, // Aqui usamos _imagensCaminhos

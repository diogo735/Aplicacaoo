import 'dart:io';
import 'package:ficha3/AREAS/PAGINA_DE_UMA_AREA/sub_menu_topicos/pagina_topico/pagina_publicacao_local/pagina_comentarios_publicacao/denunciar_comentario_pub.dart';
...
late int user_id;
  ...
  String formatarData(String dataIso) {
    DateTime parsedData = DateTime.parse(dataIso); // Converter string ISO para DateTime
    String dataFormatada = DateFormat('dd/MM/yyyy \'às\' HH:mm').format(parsedData); // Formatar a data
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            formatarData(widget.dataComentario),
                            style: const TextStyle(
                    ...
                    PopupMenuItem(
                      onTap: () async {
                        String resultado = await ApiPublicacoes()
                            .apagarComentarioPublicacao(widget.idComentario);
                        ...
                        if (resultado == "Comentário Apagado!") {
                          // Excluir da base de dados local
                    ...
                    PopupMenuItem(
                      ...
                      child: const Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Denunciar', style: TextStyle(color: Colors.red)),
                        ],
                      ),
                    ),
                ];

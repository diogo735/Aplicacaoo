...
class DenunciaDialogPUB extends StatefulWidget {
  final String nome;
  ...
  @override
  _DenunciaDialogPUBState createState() => _DenunciaDialogPUBState();
}

class _DenunciaDialogPUBState extends State<DenunciaDialogPUB> {
                          ...
                          Center(
                            ...
                            onPressed: () async {
                              if (_selectedReason != null) {
                                 final apiPublicacoes = ApiPublicacoes();
                                String resultado =
                                    await apiPublicacoes.criarDenunciaPublicacao(
                                ...
                                if (resultado == "Denúncia enviada com sucesso!") {

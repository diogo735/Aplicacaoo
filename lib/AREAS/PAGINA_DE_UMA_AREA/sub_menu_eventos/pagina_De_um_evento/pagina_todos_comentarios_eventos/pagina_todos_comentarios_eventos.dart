...
class pag_cometarios_evento extends StatefulWidget {
  // ignore: non_constant_identifier_names
  final int id_evento;
final Color cor;
  // ignore: non_constant_identifier_names
  const pag_cometarios_evento({super.key, required this.id_evento,required this.cor});

  @override
  // ignore: library_private_types_in_public_api
  _pag_cometarios_eventoState createState() => _pag_cometarios_eventoState();
}

// ignore: camel_case_types
class _pag_cometarios_eventoState extends State<pag_cometarios_evento> {
  ...
  void _carregarComentariosEventos() async {
    List<Map<String, dynamic>> comentariosCarregados =
        await Funcoes_Comentarios_Eventos.consultaComentariosPorEvento(widget.id_evento);
            ...
            child: IconButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => criar_cometario_evento(cor: widget.cor,
                          id_evento: widget.id_evento)),
                );
              },
              iconSize: 23,
            ),
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  print('Texto do Comentário: ${comentario['texto_comentario']}');

...
class PaginaEventoValidado extends StatefulWidget {
  final int cor;

  const PaginaEventoValidado({
    super.key,
    required this.cor,
  });

  @override
  _PaginaEventoValidadoState createState() => _PaginaEventoValidadoState();
}

class _PaginaEventoValidadoState extends State<PaginaEventoValidado> {
  @override
  void initState() {
    super.initState();
  }
